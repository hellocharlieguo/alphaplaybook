...
export const SYS_DETAILS: Record<string, SysDetail> = {
  engine: {
    ...
    blocks: [
      ...
      { t: 'note', text: 'Full per-name arithmetic lives in v34_worksheet.html — click any cell for its derivation. Canonical always tracks the latest cycle; dated copies are snapshots. Deliberately not restated here: a second copy of the numbers is a second thing to drift.' },
    ],
  ...
  themes: {
    ...
    files: [
      ...
      { path: 'v34_worksheet.html', role: 'canonical worksheet — always the latest cycle; per-name arithmetic', status: 'live' },
      { path: 'v34_worksheet_2026-09-07.html', role: 'snapshot — 2026-09-07 cycle: wave advance, corr refresh, NOT frozen to cron', status: 'live' },
      { path: 'v34_worksheet_2026-08-31.html', role: 'snapshot — 2026-08-31 v3.4.1 stageflip; this is the deployed book', status: 'live' },
      { path: 'v34_worksheet_2026-08-24.html', role: 'snapshot — 2026-08-24 v3.4 baseline', status: 'live' },
