...
const BASE_PORTFOLIO = {
  LLY:   { base_weight: 13.2, theme: 'AI Applied',        min_weight:  6.6, action: 'Trim' },
  AMZN:  { base_weight: 13.2, theme: 'AI Applied',        min_weight:  6.6, action: 'Add' },
  IBIT:  { base_weight: 12.2, theme: 'Monetary',          min_weight:  6.1, action: 'Hold' },
  GLDM:  { base_weight:  9.1, theme: 'Monetary',          min_weight:  4.5, action: 'Hold' },
  ETHA:  { base_weight: 12.4, theme: 'Tokenized Rails',   min_weight:  6.2, action: 'Add' },
  HOOD:  { base_weight:  7.4, theme: 'Tokenized Rails',   min_weight:  3.7, action: 'Trim' },
  SLV:   { base_weight:  7.8, theme: 'Monetary',          min_weight:  3.9, action: 'Hold' },
  AIPO:  { base_weight:  6.4, theme: 'AI Buildout',       min_weight:  3.2, action: 'Hold' },
  GLW:   { base_weight:  5.6, theme: 'AI Buildout',       min_weight:  2.8, action: 'Add' },
  SOXX:  { base_weight:  6.0, theme: 'AI Buildout',       min_weight:  3.0, action: 'Add' },
  COPX:  { base_weight:  6.7, theme: 'AI Buildout',       min_weight:  3.4, action: 'Add' },
}
...
const PORTFOLIO_VERSION = '2026-09-14-v3.5-asmlcut'
